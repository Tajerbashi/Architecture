using External.Provider.Extentions;
using External.Provider.Models.Enums;

namespace External.Provider.Models
{
    public class LogModel
    {
        ...
        public override string ToString()
        {
            ...
            {
                return ($@"کاربر فوق با نام کاربری {Username} و لینک فوق {Url} متد {Method} از سرویس {Service} را همراه با پاراماتر های ذیل {Param} در تاریخ {RequestTime} درخواست کرده است");
            }
            else if (Model == HttpMode.Response)
            {
                return ($@"کاربر فوق با نام کاربری {Username} و لینک فوق {Url} متد {Method} از سرویس {Service} را همراه با پاراماتر های ذیل {Param} در تاریخ {ResponseTime} پاسخ دریافت کرده است");
            }
            else
            {
