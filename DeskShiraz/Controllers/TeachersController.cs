    ...
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Products != null ?
                        ...
                        Problem("Entity set 'DatabaseContext.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Family")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
                _context.Add(teacher);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Family")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
