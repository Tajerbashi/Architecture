...
namespace Domain.Library.ValueObjects
{
    ...
    public static class Errors
    {
        public static class General
        {
            ...
            public static Error ValueIsInvalid() => new("2", "Value is Invalid");
            public static Error InternalServerError(string error) => new("5", error);
            public static Error ValueIsRequired(string propertyName) => new("10", $"{propertyName} is Required");
            public static Error InvalidLength() => new("15", "Value is Invalid");
